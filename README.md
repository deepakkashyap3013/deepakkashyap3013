...
- **Databases:** Postgres, MongoDB, Pinecone, Redis, Memcached
...
| Resources                                                           |  Description      | Link |  
| :---------------------------------------------------------------- | :------------------------ | :--------- |
My own write ups on React Design Patterns	| Blog | [Resource Link](https://medium.com/@kashyapdeepak) |
Postgres 14 internals (PDF) | Database Internals |  [Resource Link](https://drive.google.com/file/d/1VSpegxkfvvi2oONdPsnWSyZ18G9LscDm/view?usp=sharing) |
Vector Database	| Technincal Article |  [Resource Link](https://www.pinecone.io/learn/vector-database/) 
Arpit Bhayani's Papershelf | Research Papers | [Resource Link](https://arpitbhayani.me/papershelf)
System Design (Frontend) | YT playlist | [Resource Link](https://www.youtube.com/playlist?list=PLI9W87-Dqn7j_x6QtR6sUjycJR7nQLBqT) |
In Depth Backend Resources By Hussein Nasser | Course | [Udemy Courses](https://www.udemy.com/user/hussein-nasser-7/) , [Youtube](https://www.youtube.com/@hnasr)|
Node JS Internals By Gabriel Zimmermann | YT Video | [Resource Link](https://www.youtube.com/watch?v=OCjvhCFFPTw) |
Visualize Docker and K8 through the lens of Stephen Grider | Course | [Udemy Course](https://www.udemy.com/course/docker-and-kubernetes-the-complete-guide/)
